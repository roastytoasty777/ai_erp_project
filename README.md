...
If <img src="https://latex.codecogs.com/svg.latex?\color{white}P(\text{item})>0.6" style="vertical-align: middle; display: inline-block;" height="16pt" />, the system flags the item as CRITICAL risk.